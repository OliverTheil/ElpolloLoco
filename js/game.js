...
loadBackground = () => {
  document.getElementById("canvas").style =
    "background-image: url('Inhalte/img/9.Intro _ Outro Image/Start Screen/Opciขn 1.png')";
};
...
enableEndscreenLost = () => {
  if (fullscreen == true) {
    document.getElementById("canvas").style =
      "width: 100%; height: 100vh; border-radius: 0px; background-position: center; background-image: url('Inhalte/img/9.Intro _ Outro Image/_Game over_ screen/4.Game over!.png')";
  } else {
    document.getElementById("canvas").style =
      "background-position: center; background-image: url('Inhalte/img/9.Intro _ Outro Image/_Game over_ screen/4.Game over!.png')";
  }
  enableReplayButton();
  alive = false;
};
...
enableReplayButton = () => {
  ...
  document
    ...
    .setAttribute("onclick", "enableReplay()");
...
enableEndscreenWon = () => {
  if (fullscreen) {
    document.getElementById("canvas").style =
      "width: 100%; height: 100vh; border-radius: 0px; background-image: url('Inhalte/img/9.Intro _ Outro Image/Start Screen/Opciขn 1.png')";
  } else {
    document.getElementById("canvas").style =
      "background-image: url('Inhalte/img/9.Intro _ Outro Image/Start Screen/Opciขn 1.png')";
  }
...
noFullscreenAlive = () => {
  ...
  document.getElementById("canvas").style =
    "width: 100%; height: 100vh; border-radius: 0px; background-image: url('Inhalte/img/9.Intro _ Outro Image/Start Screen/Opciขn 1.png'); background-size: cover; background-position: 20%";
  fullscreen = true;
};
